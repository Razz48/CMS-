...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
        href="assets2/images/favicon-icon/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
        href="assets2/images/favicon-icon/apple-touch-icon-114-precomposed.html">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
        href="assets2/images/favicon-icon/apple-touch-icon-72-precomposed.png">
                ...
                <div class="row">
                    <div class="col-md-5 col-md-push-7">
                        <div class="banner_content">
                            ...
                            <p>We have different flavours for you to choose. </p>                        
                                    </div>
                    </div>
                </div>
            </div>
...
?>
                            ...
                            <div class="col-list-3">
                                <div class="recent-Cake-list">
                                    ...
                                    <div class="car-info-box" style="width:100%; height:300px"> 
                                    ...
                                    <div class="Cake-title-m" style="color:black;">
                                        ...
                                        <span class="price">Rs <?php echo htmlentities($row['productPrice']);?> <s> Rs
                                                <?php echo htmlentities($row['productPriceBeforeDiscount']);?></s></span>
                                    </div>
