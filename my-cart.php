    ...
    <body class="cnt-home">
        ...
        if($num > 0) {
            ...
            while($row = mysqli_fetch_array($query)) {
                ...
                $price = $row['pprice'];
                $total = $qty * $price;
                // Only display rows where the quantity is greater than zero
                if ($qty > 0) {
                                            ?>
                                            <tr>
                                                <td><?php echo $cnt;?></td>
                                                ...
                                                <td class="cart-product-grand-total"><?php echo $total;?></td>
                    ...
                    // Optionally, you can add a row indicating the item was not ordered
                    // echo "<tr><td colspan='9'>Item not ordered</td></tr>";
                }
            }
        } else {
                                            ?>
